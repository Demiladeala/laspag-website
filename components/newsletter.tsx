...
export default function Newsletter({}: Props) {
  return (
    <div className='newsletter-outer py-10 sm:pt-20 font-normal'>
      <motion.div
      initial={{opacity:0,x:10}}
      whileInView={{opacity:1,x:0}}
      transition={{duration:1}}
      viewport={{once: true}} 
      className="newsletter-inner sm:w-4/6 w-[90%] mx-auto rounded-3xl bg-white text-center sm:space-y-10 space-y-3 sm:p-14 py-10 px-5">
        <h3 className='sm:text-3xl font-bold border-l-[#D8A61F] text-base'>SUBSCRIBE TO OUR NEWSLETTER</h3>
        <p className='sm:text-xl text-sm'>Subscribe to our newsletter to get updates on our products</p>
        ...
        <form action="" className='w-5/6 mx-auto sm:h-20 h-10 flex flex-between border-[#D8A61F] rounded-3xl border-2 overflow-hidden'>
          ...
          <button type="submit" className='news-btn h-full w-2/6 bg-[#D8A61F] hover:bg-[#D8A61F]/80 sm:rounded-2xl sm:text-xl text-[10px] sm:px-0 px-2 text-white'>Subscribe</button>
        </form>
