    ...
    <div className='newsletter-outer sm:py-20 mt-20 font-normal'>
      ...
      className="newsletter-inner sm:w-4/6 w-[90%] mx-auto rounded-3xl bg-white text-center sm:space-y-10 space-y-3 sm:p-14 py-10 px-5 mt-10 sm:mt-0">
        ...
        <form action="" className='w-5/6 mx-auto sm:h-16 h-10 flex flex-between border-[#D8A61F] rounded-3xl border-2 overflow-hidden'>
          ...
          <button type="submit" className='news-btn h-full w-2/6 bg-[#D8A61F] sm:rounded-2xl sm:text-xl text-[12px] sm:px-0 px-2text-white hover:bg-[#D8A61F]/80 relative left-0 text-white'>Subscribe</button>
        </form>
